...
import numpy as np
import optax
from optimizers.tearfree import grafting
from optimizers.tearfree import momentum
from optimizers.tearfree import optimizer
from optimizers.tearfree import praxis_shim
from optimizers.tearfree import second_order
from optimizers.tearfree import shampoo
...
class OptimizerTest(parameterized.TestCase):
    ...
    def _grafting_tx_with_momentum(self, grafting_options, momentum_options, lr=0.1):
    ...
    def test_momentum_yes_graft(self, grafting_options):
        ...
        tx = self._grafting_tx_with_momentum(grafting_options, options.momentum_options)
